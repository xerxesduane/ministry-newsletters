...
function smtp_help(): string {
    return [
        ...
        '  EPISTLE_SMTP_USER      the mailbox to send from',
        '  EPISTLE_SMTP_PASS      an app password, not the account password',
        '  EPISTLE_SMTP_FROM      address partners see (defaults to the user above)',
        '  EPISTLE_SMTP_FROM_NAME e.g. "The Rock City Church"',
        '  EPISTLE_SMTP_REPLY_TO  where replies should go (optional)',
        '',
